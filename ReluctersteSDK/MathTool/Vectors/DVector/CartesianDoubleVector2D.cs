...
{
    /// <summary>
    /// 表示基于 <see cref="double"/> 的 2D 双精度笛卡尔坐标向量 (X, Y)。<br/>
    /// 不可变 (readonly struct)，适用于高精度地理/物理计算。
    /// </summary>
    public readonly struct CartesianDoubleVector2D : IEquatable<CartesianDoubleVector2D>
    {
        ...
        public static CartesianDoubleVector2D Zero => new CartesianDoubleVector2D(0.0, 0.0);
        /// <summary>获取双精度全一向量 (1, 1)。</summary>
        public static CartesianDoubleVector2D One => new CartesianDoubleVector2D(1.0, 1.0);
        /// <summary>获取双精度 X 轴单位向量 (1, 0)。</summary>
        public static CartesianDoubleVector2D UnitX => new CartesianDoubleVector2D(1.0, 0.0);
        /// <summary>获取双精度 Y 轴单位向量 (0, 1)。</summary>
        public static CartesianDoubleVector2D UnitY => new CartesianDoubleVector2D(0.0, 1.0);
